...
namespace WasteIS.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Type,Name,Phone,Address")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Type,Name,Phone,AddressID")] Company company)
        {
            if (ModelState.IsValid)
            {
